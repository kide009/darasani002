...
class OnDemandClassesLessonScreen extends StatefulWidget {
  const OnDemandClassesLessonScreen({Key? key}) : super(key: key);

  @override
  State<OnDemandClassesLessonScreen> createState() =>
      _OnDemandClassesLessonScreenState();
}

class _OnDemandClassesLessonScreenState
    extends State<OnDemandClassesLessonScreen> {
  bool summary = false;
              ...
              child: Container(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    CustomText(
                      title:
                          "Quickly check through these items before exporting to get responsive, higH ",
                      fontSize: 11,
                      maxLines: 2,
                        ...
                        ? Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomText(
                                  title:
                                      "Lorem ipsum dolor sit amet, consectetu ryguu adipiscing elit, sed do eiusmodiuiuiuij temporuiuiuq incididunt ut labore et dolores magna aliquap Ut enim ad minim veniam, its quis nostrudjj poo exercitation ullamcomoum laboris nisi ut aliquip ex ea commodookolom consequat. ",
